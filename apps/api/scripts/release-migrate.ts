...
function assertRuntime(rows: readonly MigrationRow[]): void {
...
async function stagedMigrate(target: typeof PHASE1_TARGET_MIGRATION, databaseUrl: string): Promise<void> {
	const root = apiRoot();
