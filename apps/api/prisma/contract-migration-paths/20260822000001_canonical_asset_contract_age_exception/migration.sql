...
-- Explicit alternate history: only the observation age comparison is waived.
...
BEGIN
  IF (SELECT count(*) FROM "release_contract_authorizations"
      WHERE "migration_name" = '20260822000001_canonical_asset_contract_age_exception'
        AND "scope" = '24-hour-observation-age-only'
...
FROM "release_contract_authorizations" WHERE "migration_name" = '20260822000001_canonical_asset_contract_age_exception';
